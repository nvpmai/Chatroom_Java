...
public class ChatboxView extends JFrame {
    ...
    private final JButton clear_button        = new JButton(new ImageIcon("images/trash_button.png"));
    ...
    public ChatboxView() {
        ...
        // Set button's tooltips
        emotion_button.setToolTipText("Send emoticon");
        attachment_button.setToolTipText("Send file(txt, pdf, java, zip)");
        status_button.setToolTipText("Set status");
        block_button.setToolTipText("Block user");
        clear_button.setToolTipText("Clear history");
        ...
        textPane.setDocument(new AdvancedRTFDocument());
    ...
    public JDialog   getEmoticonPanel() { return emoticonsPanel; }

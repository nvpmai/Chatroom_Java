    ...
    public void updateText(String message) {
        if (message != null) {
            if (message.charAt(0) == ' ') {                         // If the string is a code to perform a function
                ...
                else if (blocked_by.contains(notification[1])) return;   // Do nothing if this account is blocked by the sender
                ...
                if (message.charAt(0) == '!') {                                     // Someone send emoticon privately
                    if (blocked_by.contains(message.substring(1, index))) return;   // This account is blocked by the sender
                    ...
                    if (blocked_by.contains(message.substring(0, index))) return;
